...
const outputPath = path.join(publicDir, "client-agreement-taskzing.pdf");
...
// Convert to JPEG first for better compatibility across PDF viewers.
...
const heading = "Client-Provider Service Agreement (Form)";
...
line(
  "Please complete this agreement form accurately before starting the service.",
  { size: 9, gap: 12 }
);
line(
  "Both parties should review all sections, confirm payment terms, and keep a signed copy for records.",
  { size: 9, gap: 18 }
);
...
line("Provider Address: _______________________________________________________________", { gap: 18 });

section("3) Task / Service Details");
line("Task Title: _____________________________________________________________________");
line("Task Category: __________________________________________________________________");
...
section("4) Payment Terms (Client <-> Provider)");
...
line("Payment Schedule / Milestones:");
line("________________________________________________________________________________");
line("________________________________________________________________________________");
...
line("Provider Responsibilities:");
line("________________________________________________________________________________");
line("Client Responsibilities:");
line("________________________________________________________________________________");
line("Expected Deliverables:");
line("________________________________________________________________________________", { gap: 18 });
...
section("Note");
line(
  "By signing this form, both parties agree to TaskZing Terms & Conditions.",
  { size: 9, gap: 12 }
);
line(
  "TaskZing is not liable for payment disputes, non-payment, service disputes, damages, delays,",
  { size: 9, gap: 12 }
);
line(
  "or contractual claims between client and provider unless explicitly provided in official TaskZing workflow.",
  { size: 9, gap: 12 }
);
